...
class FastProcessor(
    ...
    override fun process(resolver: Resolver): List<KSAnnotated> {
        ...
        val classes = resolver
            .getSymbolsWithAnnotation("com.cws.kmemory.FastObject")
...
//            )
        ...
        val stackFunBuilder = FunSpec.builder(generatedName)
            .receiver(ClassName(pkg, "StackMemory"))
            .returns(generatedClassName)
        ...
        fileSpec.addImport("com.cws.kmemory", "NULL")
        fileSpec.addImport("com.cws.kmemory", "checkNotNull")
        fileSpec.addImport("com.cws.kmemory", "HeapMemory")
        fileSpec.addImport("com.cws.kmemory", "StackMemory")
...
//        generatePrimitiveCollections()
    ...
    private fun generatePrimitiveCollections() {
        primitiveTypes.forEach { type ->
            generateFastList("com.cws.kmemory.collections", type)
            generateFastSet("com.cws.kmemory.collections", type)
        }
        primitiveTypes.forEach { key ->
            primitiveTypes.forEach { value ->
                generateFastMap("com.cws.kmemory.collections", key, value)
            }
        }
    }
