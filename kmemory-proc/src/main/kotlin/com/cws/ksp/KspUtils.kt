...
fun com.google.devtools.ksp.symbol.Modifier.toKModifier(): KModifier =
    when (this) {
        com.google.devtools.ksp.symbol.Modifier.ABSTRACT -> KModifier.ABSTRACT
        com.google.devtools.ksp.symbol.Modifier.OVERRIDE -> KModifier.OVERRIDE
        com.google.devtools.ksp.symbol.Modifier.PRIVATE -> KModifier.PRIVATE
        com.google.devtools.ksp.symbol.Modifier.PROTECTED -> KModifier.PROTECTED
        com.google.devtools.ksp.symbol.Modifier.PUBLIC -> KModifier.PUBLIC
